...
from .views import venue_list, venue_detail, create_booking, owner_dashboard, submit_review, notification_list, create_venue, admin_dashboard
from . import views
...
urlpatterns = [
    ...
    path('venue/<int:venue_id>/review/', submit_review, name='submit_review'),
